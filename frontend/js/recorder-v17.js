...
// =============================================================================
console.log('%c🔥 RECORDER-V17.JS LOADED 🔥', 'background: #00ff00; color: #000000; font-size: 20px; font-weight: bold; padding: 10px;'); // #claude
console.log('V17: MEMORY UPLOAD + 50MB INFLATION TEST MODE'); // #claude

// Update visible version badge on screen (no console needed!)
if (document.getElementById('versionBadge')) {
    document.getElementById('versionBadge').textContent = '✅ V17 - 50MB TEST';
