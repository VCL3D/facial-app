...
// =============================================================================
// VERSION MARKER // #claude
// =============================================================================
console.log('%c🔥 RECORDER.JS V13 LOADED 🔥', 'background: #ff0000; color: #ffffff; font-size: 20px; font-weight: bold; padding: 10px;'); // #claude
console.log('V13: Chunks stored in MEMORY during recording, inflate BEFORE IndexedDB save'); // #claude

// =============================================================================
// TEST MODE CONFIGURATION // #claude
// =============================================================================
const TEST_MODE = { // #claude
    enabled: true, // #claude - RE-ENABLED: Now inflates in memory BEFORE chunking (no slow getVideoBlob)
