...
// =============================================================================
// VERSION MARKER - V18 (BUTTON FIX) // #claude
// =============================================================================
console.log('%c🔥 RECORDER-V18.JS LOADED 🔥', 'background: #00ff00; color: #000000; font-size: 20px; font-weight: bold; padding: 10px;'); // #claude
console.log('V18: FIXED BUTTON STATE MANAGEMENT'); // #claude

// Update visible version badge on screen (no console needed!)
if (document.getElementById('versionBadge')) {
    document.getElementById('versionBadge').textContent = '✅ V18 - 50MB TEST';
